          ...
          <div className="max-w-4xl mx-auto">
            <div className="glass-card p-6 md:p-8 text-center">
              ...
              <p className="text-muted-foreground text-sm mb-4">
                Supported by Liepāja's Culture Department, in collaboration with Liepāja Museum. Reach out to the team for any questions.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center text-sm">
                <a href="mailto:team@ponder.lv" className="text-primary hover:underline">
                  team@ponder.lv
                </a>
                <span className="hidden sm:inline text-muted-foreground">·</span>
                <a href="tel:+37128241990" className="text-primary hover:underline">
                  +371 28241990
                </a>
              </div>
            </div>
